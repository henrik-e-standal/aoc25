...
namespace Aoc25.Day5
{
    public class Program
    {
...
#if DEBUG
                puzzleInput = Day5A.PuzzleInput.Personalized;
#else
                puzzleInput = null;
#endif
            }
        ...
        public static void Main(string[] args)
        {
            ...
            {
                BenchmarkTimer.Tick();
                puzzleResultPartA = Day5A.PuzzleSolver.Solve(puzzleInput);
                puzzleResultPartB = Day5B.PuzzleSolver.Solve(puzzleInput);
                BenchmarkTimer.Tock();
