...
namespace Aoc25.Day7
{
    public class Program
    {
...
#if DEBUG
                puzzleInput = Day7A.PuzzleInput.Personalized;
#else
                puzzleInput = null;
#endif
            }
        ...
        public static void Main(string[] args)
        {
            ...
            {
                BenchmarkTimer.Tick();
                puzzleResultPartA = Day7A.PuzzleSolver.Solve(puzzleInput);
                puzzleResultPartB = Day7B.PuzzleSolver.Solve(puzzleInput);
                BenchmarkTimer.Tock();
