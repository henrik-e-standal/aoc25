...
namespace Aoc25.Day1
{
    public class Program
    {
...
#if DEBUG
                puzzleInput = Day1A.PuzzleInput.Personalized;
#else
                puzzleInput = null;
#endif
            }
        ...
        public static void Main(string[] args)
        {
            ...
            {
                BenchmarkTimer.Tick();
                puzzleResultPartA = Day1A.PuzzleSolver.Solve(puzzleInput);
                puzzleResultPartB = Day1B.PuzzleSolver.Solve(puzzleInput);
                BenchmarkTimer.Tock();
