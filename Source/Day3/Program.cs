...
namespace Aoc25.Day4A
{
    public class Program
    {
...
#if DEBUG
                puzzleInput = Day3A.PuzzleInput.Personalized;
#else
                puzzleInput = null;
#endif
            }
        ...
        public static void Main(string[] args)
        {
            ...
            {
                BenchmarkTimer.Tick();
                puzzleResultPartA = Day3A.PuzzleSolver.Solve(puzzleInput);
                puzzleResultPartB = Day3B.PuzzleSolver.Solve(puzzleInput);
                BenchmarkTimer.Tock();
