...
namespace Aoc25.Common
{
    ...
    /// It is designed to efficiently manage and retrieve the smallest item in a collection of items. 
    ...
    public sealed class MinHeap<T> : IEnumerable<T> where T : IComparable<T>
    {
        ...
        /// <summary>
        /// Creates a new <see cref="MinHeap{T}"/> with the specified fixed capacity.
        /// </summary>
        /// <param name="capacity"> The fixed capacity of the heap. </param>
        public MinHeap(int capacity) : this((uint)capacity)
        {
            // Intentionally empty.
        }  
        ...
        /// </summary>
        /// <param name="capacity"> The fixed capacity of the heap. </param>
        public MinHeap(uint capacity)
        {
            data = new T[capacity];
        }

        /// <summary>
        /// Creates a new <see cref="MinHeap{T}"/> from a collection of items. 
        ...
        public MinHeap(ref T[] data, int count)
        { 
            this.data = data;
            this.count = count;
            ...
            // Construct a min-heap out of the passed data.
        ...
        /// <summary>
        /// Restores the min-heap property for the subtree rooted at the specified index.
        /// </summary>
        ...
        private void Heapify(int currentIndex)
        {
            ...
            while (true)
            {
                ...
                if (currentItem.CompareTo(data[smallestIndex]) <= 0)
                    break;

                data[currentIndex] = data[smallestIndex];
        ...
        /// <summary>
        /// Adds a new item to the heap, then removes the smallest item in the heap and returns it.
        /// </summary>
        /// <param name="item"> The item to add. </param>
        /// <returns> The smallest item in the heap, after adding the new item. </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public T PushAndPop(T item)
        {
            T smallestItem;

            // If the new item would be the new smallest item, simply return it
            ...
            else 
            {
                ...
                // Overwrite the root (i.e. smallest) item in the heap with the new item.
                data[0] = item;
        ...
        /// <summary>
        /// Attempts to first add a new item to the heap, then remove the smallest item in the heap and return it.
        /// </summary>
        ...
        /// <summary>
        /// Attempts to remove the smallest item in the heap and return it.
        /// </summary>
        /// <param name="item" The smallest item, if the operation is successful. </param>
        ...
        /// <summary>
        /// Removes smallest item in the heap, adds a new item to the heap, and returns the removed item.
        /// </summary>
        /// <param name="item"> The item to add. </param>
        /// <returns> The smallest item in the heap. </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// Attempts to remove the smallest item in the heap, add a new item, and return the removed item.
        /// </summary>
        /// <param name="newItem"> The item to add. </param>
        ...
        /// <summary>
        /// Attempts to remove the smallest item in the heap.
        /// </summary>
        ...
        /// <summary>
        /// Removes smallest item in the heap and then adds an item to the heap.
        /// </summary>
        /// <param name="item"> The item to add. </param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// Attempts to remove smallest item in the heap and then add an item to the heap.
        /// </summary>
        /// <param name="item"> The item to add. </param>
        /// <returns> True if an item could be removed from the heap, false if the heap was empty. </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <summary>
        /// Retrieves the smallest item stored in the heap (without removing it).
        /// </summary>
        /// <returns> The item stored at the front of the heap. </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public T Peek()
        {
            return data[0];
        ...
        /// <summary>
        /// Attempts to retrieve the smallest item stored in the heap (without removing it).
        /// </summary>
        /// <param name="item" The retrieved item, if the operation is successful. </param>
        /// <returns> True if an item could be retrieved from the heap, false if the heap was empty. </returns>
        ...
        /// </summary>
        /// <returns>
        /// A new <see cref="MinHeap{T}"/> instance containing the same elements and 
        ...
        {
            var newHeap = new MinHeap<T>(data.Length);
        ...
        /// <summary>
        /// Converts the heap to a <see cref="MaxHeap{T}"/> by "transferring" ownership of the 
        /// heap's internal data to the new heap.
        /// </summary>
        /// <remarks>
        /// As this operation will transfer the internal data of the current heap to the created 
        /// <see cref="MaxHeap{T}"/>, the current heap will be left in an unusable state.
        /// </remarks>
        /// <returns> A new <see cref="MaxHeap{T}"/> using this heap's internal data. </returns>
        public MaxHeap<T> ConvertToMaxHeap()
        {
            return new MaxHeap<T>(ref data, count);
        }

        /// <summary>
        /// Gets an enumerator for enumerating the content of the heap in order (from smallest to largest).
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// An enumerator for enumerating the content of a <see cref="MinHeap{T}"/> in order.
        /// </summary>
        public struct OrderedHeapEnumerator : IEnumerator<T> 
        {
            /// <summary>
            /// A copy of the <see cref="MinHeap{T}"/> being enumerated.
            /// </summary>
            private readonly MinHeap<T> heap;
            ...
            public OrderedHeapEnumerator(MinHeap<T> heap)
            {
        ...
        /// <summary>
        /// An enumerator for enumerating the content of a <see cref="MinHeap{T}"/> in an undefined order.
        /// </summary>
        public struct UnorderedHeapEnumerator : IEnumerator<T> 
        {
            /// <summary>
            /// The <see cref="MinHeap{T}"/> instance being enumerated.
            /// </summary>
            private readonly MinHeap<T> heap;
            ...
            /// </summary>
            /// <param name="heap"> The heap to enumerate. </param>
            public UnorderedHeapEnumerator(MinHeap<T> heap)
            {
                this.heap = heap;
                this.currentIndex = -1;
            }
