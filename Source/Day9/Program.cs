...
namespace Aoc25.Day9
{
    public class Program
    {
...
#if DEBUG
                puzzleInput = Day9A.PuzzleInput.Personalized;
#else
                puzzleInput = null;
#endif
            }
        ...
        public static void Main(string[] args)
        {
            ...
            {
                BenchmarkTimer.Tick();
                puzzleResultPartA = Day9A.PuzzleSolver.Solve(puzzleInput);
                puzzleResultPartB = Day9B.PuzzleSolver.Solve(puzzleInput);
                BenchmarkTimer.Tock();
