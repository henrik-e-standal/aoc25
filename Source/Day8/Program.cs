...
namespace Aoc25.Day8
{
    public class Program
    {
...
#if DEBUG
                puzzleInput = Day8A.PuzzleInput.Personalized;
#else
                puzzleInput = null;
#endif
            }
        ...
        public static void Main(string[] args)
        {
            ...
            {
                BenchmarkTimer.Tick();
                puzzleResultPartA = Day8A.PuzzleSolver.Solve(puzzleInput);
                puzzleResultPartB = Day8B.PuzzleSolver.Solve(puzzleInput);
                BenchmarkTimer.Tock();
